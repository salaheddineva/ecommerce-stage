...
<template>
    <div>
      ...
      <button class="px-4  bg-[#ECDAC3] text-black rounded-[10px] hover:bg-[#ECDAC3] focus:outline-none focus:ring-2 focus:ring-[#ECDAC3] focus:ring-offset-2">Chercher</button>
