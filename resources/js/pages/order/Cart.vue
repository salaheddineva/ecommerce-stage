...
<template>
    <div class="flex flex-col justify-center  h-full">
        ...
        <div class="flex  space-x-0 ml-[50%]">
            <CustomButton class="text-[#ECDAC3]  rounded-[9px] h-[50px] px-8 py-3" button="Retour" />
            <router-link :to="{ name: 'payment' }">
                <CustomButton class="bg-[#ECDAC3]   rounded-[9px] h-[50px] px-8 py-3 " button="Confirmer" />
            </router-link>
        </div>
    </div>
</template>